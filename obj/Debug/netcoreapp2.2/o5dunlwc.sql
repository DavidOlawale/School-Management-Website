...
EXEC sp_rename N'[Attendances].[AttendanceId]', N'Id', N'COLUMN';

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20191020213448_AttendanceId-to-Id', N'2.2.3-servicing-35854');
...
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Classes]') AND [c].[name] = N'TeacherId');
IF @var2 IS NOT NULL EXEC(N'ALTER TABLE [Classes] DROP CONSTRAINT [' + @var2 + '];');
ALTER TABLE [Classes] DROP COLUMN [TeacherId];

GO

ALTER TABLE [AspNetUsers] ADD [Teacher_ClassId] int NULL;
...
ALTER TABLE [AspNetUsers] ADD CONSTRAINT [FK_AspNetUsers_Classes_Teacher_ClassId] FOREIGN KEY ([Teacher_ClassId]) REFERENCES [Classes] ([Id]);

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20191102091802_ClassHasTeacher-To-TeacherHasClass', N'2.2.3-servicing-35854');

GO

ALTER TABLE [AspNetUsers] DROP CONSTRAINT [FK_AspNetUsers_Department_DepartmentId];

GO

ALTER TABLE [AspNetUsers] ADD CONSTRAINT [FK_AspNetUsers_Department_DepartmentId] FOREIGN KEY ([DepartmentId]) REFERENCES [Department] ([Id]) ON DELETE SET NULL;

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20191111182550_Add-Department-and-Subject', N'2.2.3-servicing-35854');
