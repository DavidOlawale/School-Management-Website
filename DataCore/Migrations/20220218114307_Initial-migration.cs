        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThirdTermId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasProfilePhoto = table.Column<bool>(nullable: false),
                    ProfilePhotoExtension = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ToAllParents = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepartmentSubjectSubjectId = table.Column<int>(nullable: false),
                    TermId = table.Column<int>(nullable: false),
                    Score = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Exams", x => new { x.DepartmentSubjectDepartmentId, x.DepartmentSubjectSubjectId, x.StudentId, x.TermId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tests", x => new { x.DepartmentSubjectDepartmentId, x.DepartmentSubjectSubjectId, x.StudentId, x.TermId });
                    table.ForeignKey(
