...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataCore.Models.Class", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DataCore.Models.Admin", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("DataCore.Models.ApplicationRole")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("DataCore.Models.ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("DataCore.Models.Attendance", b =>
                {
                    b.HasOne("DataCore.Models.Student")
                        .WithMany("Atendances")
            ...
            modelBuilder.Entity("DataCore.Models.Student", b =>
                {
                    b.HasOne("DataCore.Models.Class", "Class")
                        .WithMany("Students")
                    ...
                    b.HasOne("DataCore.Models.Parent")
                        .WithMany("Children")
